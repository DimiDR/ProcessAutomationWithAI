...
"[project]/src/app/canvas/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CanvasPage() {
    ...
    const [savedCanvases, setSavedCanvases] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    const [currentCanvasName, setCurrentCanvasName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("Untitled Canvas");
    const [isCreatingCanvas, setIsCreatingCanvas] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const loadCanvasData = (data)=>{
        ...
        try {
            ...
            data.nodes.forEach((node)=>{
                const vertex = graph.insertVertex(graph.getDefaultParent(), node.id, node.label, node.position.x, node.position.y, 120, 60, node.type === "start" ? "shape=ellipse;fillColor=#4CAF50;fontColor=white;" : node.type === "end" ? "shape=ellipse;fillColor=#f44336;fontColor=white;" : "");
            ...
            if (data.edges) {
                data.edges.forEach((edge)=>{
                    ...
                    if (source && target) {
                        graph.insertEdge(graph.getDefaultParent(), edge.id, "", source, target);
                    }
                });
            }
        } finally{
    ...
    const saveCurrentCanvas = ()=>{
        ...
        localStorage.setItem(`canvases_${user?.email}`, JSON.stringify(updatedCanvases));
        alert("Canvas saved successfully!");
        // Track canvas save activity
        if (user) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$activityTracker$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ActivityTracker"].trackActivity({
                userId: user.uid,
    ...
    const addNode = (type)=>{
        ...
        const vertex = graph.insertVertex(parent, null, label, 100, 100, 120, 60, style);
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Please log in to access the canvas"
                    }, void 0, false, {
                        fileName: "[project]/src/app/canvas/page.tsx",
                        lineNumber: 298,
                        columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                !guestMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: saveCurrentCanvas,
                                    className: "inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700",
                                    children: "Save Canvas"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/canvas/page.tsx",
                                    lineNumber: 374,
                                    columnNumber: 15
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: "Click and drag to create connections between nodes"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/canvas/page.tsx",
                                                    lineNumber: 429,
                                                    columnNumber: 17
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                            ...
                                            children: "Saved Canvases"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/canvas/page.tsx",
                                            lineNumber: 444,
                                            columnNumber: 15
                                        }, this),
                                        !guestMode ? savedCanvases.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "space-y-2",
                                            children: savedCanvases.map((canvas)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            children: "No saved canvases yet. Create and save your first canvas!"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/canvas/page.tsx",
                                            lineNumber: 461,
                                            columnNumber: 19
                                            ...
                                            className: "text-sm text-gray-500",
                                            children: "Log in to save and load canvases."
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/canvas/page.tsx",
                                            lineNumber: 466,
                                            columnNumber: 17
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e8702460._.js.map